...
const AcademicTermForm = ({ term = null, onSubmit, onCancel }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (term) {
                await academicService.updateAcademicTerm(term._id, formData);
            } else {
                await academicService.createAcademicTerm(formData);
            }
            onSubmit();
        } catch (err) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end space-x-3">
                ...
                <button
                    ...
                    disabled={loading}
                >
                    {loading ? 'Enregistrement...' : term ? 'Modifier' : 'Créer'}
                </button>
            </div>
        </form>
    );
