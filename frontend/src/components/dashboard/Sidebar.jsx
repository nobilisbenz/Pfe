import { FiHome, FiUsers, FiBook, FiMail, FiBookOpen, FiEdit, FiHelpCircle, FiCalendar } from 'react-icons/fi';
    ...
    switch (userRole) {
      ...
      case 'teacher':
        return [
          ...
          { id: 'exams', icon: FiEdit, label: 'Examens' },
          { id: 'courses', icon: FiBook, label: 'Cours' }
        ];
      case 'student':
        return [
          { id: 'overview', icon: FiHome, label: "Vue d'ensemble" },
